...
def get_filters():
    ...
    while True:
      ...
      if month.lower() not in ('january', 'february', 'march', 'april', 'may', 'june', 'all'):
        ...
        print("Sorry, Check Your Entered Month And Try again.")
    ...
    while True:
      ...
      if day.lower() not in ('sunday', 'monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday', 'all'):
        ...
        print("Sorry, Check Your Entered Day And Try again.")
...
def user_stats(df):
    ...
    #  here asing the user if they wish to see raw data from the csv file
